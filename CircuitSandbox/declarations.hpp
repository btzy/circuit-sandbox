...
// colors
constexpr static SDL_Color BLACK          { 0x17, 0x18, 0x1a, 0xFF };
constexpr static SDL_Color RED            { 0xa7, 0x20, 0x20, 0xFF };
constexpr static SDL_Color GREEN          { 0x60, 0x89, 0x28, 0xFF };
constexpr static SDL_Color YELLOW         { 0xff, 0x8c, 0x07, 0xFF };
constexpr static SDL_Color BLUE           { 0x30, 0x8b, 0xd5, 0xFF };
constexpr static SDL_Color MAGENTA        { 0x79, 0x4e, 0x87, 0xFF };
constexpr static SDL_Color CYAN           { 0x43, 0xa4, 0x99, 0xFF };
constexpr static SDL_Color WHITE          { 0xc6, 0xca, 0xc8, 0xFF };
constexpr static SDL_Color BRIGHT_BLACK   { 0x43, 0x48, 0x4f, 0xFF };
constexpr static SDL_Color BRIGHT_RED     { 0xff, 0x40, 0x40, 0xFF };
constexpr static SDL_Color BRIGHT_GREEN   { 0x57, 0xff, 0x4b, 0xFF };
constexpr static SDL_Color BRIGHT_YELLOW  { 0xf1, 0xf1, 0x07, 0xFF };
constexpr static SDL_Color BRIGHT_BLUE    { 0x82, 0xb4, 0xff, 0xFF };
constexpr static SDL_Color BRIGHT_MAGENTA { 0xc4, 0x59, 0xe3, 0xFF };
constexpr static SDL_Color BRIGHT_CYAN    { 0x1e, 0xff, 0xf4, 0xFF };
constexpr static SDL_Color BRIGHT_WHITE   { 0xf4, 0xf7, 0xf5, 0xFF };
